...
df = DataFrame(Arrow.Table("/Users/pere/genie/genieawesome/SoilMeasurements/data/bigdata.lz4"))
columns = names(df)
# the soil_data table contains the location of each station along with other information
soil_data = CSV.read("/Users/pere/genie/genieawesome/SoilMeasurements/data/big_soil_data.csv", DataFrame)
